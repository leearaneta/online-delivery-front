...
import { UPDATE_ACCOUNT, UPDATE_ACCOUNT_SUCCESS, UPDATE_ACCOUNT_FAILURE, RESET_UPDATE_ACCOUNT_STATE } from '../actions/updateAccount';
...
export default function(state = INITIAL_STATE, action) {
  ...
  switch(action.type) {
    ...
    case UPDATE_ACCOUNT:
    return { ...state, accountUpdated: false, error: null, loading: true};
